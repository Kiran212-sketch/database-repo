...
COPY public.profiles (profile_id, user_id, profile_picture, phone_number, address, two_factor_enabled, updated_at) FROM stdin;
\.
...
COPY public.users (user_id, username, email, password, first_name, last_name, created_at, updated_at) FROM stdin;
\.
